...
**Agentes de IA:** Sistemas capaces de percibir, razonar y actuar de forma autónoma para alcanzar metas específicas.

**Algoritmos de Razonamiento:** Se analizó el uso de Cadena de Pensamiento (CoT) para pasos intermedios y arquitecturas neuro-simbólicas.

**RAG (Generación Aumentada por Recuperación):** Método para evitar que la IA invente información (alucinaciones) al obligarla a consultar documentos externos reales antes de responder.

**Memoria:** Diferenciación entre memoria de corto plazo (ventana de contexto) y memoria de largo plazo (vectorial o basada en gráficos).
